...
${BIN_DIR}/$(TARGET) : ${OBJ_DIR}/main.o ${OBJ_DIR}/connection_variables.o ${OBJ_DIR}/global_hash.o ${OBJ_DIR}/query.o ${OBJ_DIR}/data.o ${OBJ_DIR}/command.o ${OBJ_DIR}/enum_data.o ${OBJ_DIR}/numeric_data.o ${OBJ_DIR}/jenkinshash.o
